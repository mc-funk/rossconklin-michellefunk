(function($) {
    ...
    var faq = [
      {
        question: "Why haven't I received a save the date/invitation?",
        answer: "We sent out Save the Dates earlier in the year, with the exception of a couple whose cards are suffering from postage supply lag (but you should know who you are). If you expected to receive one and didn't, please reach out to us. We expect to send formal invitations out by late June or early July.</p><p> It is also true that there are plenty of people we aren't able to invite! We decided early on that a smaller-format wedding was important to us. It’s definitely not because there aren’t more than 70 people that we love and want as part of our lives and marriage! However, factors like venue size, distance of loved ones from Minnesota, costs, and being able to spend more time with each guest all pointed us towards a smaller guest list. </p><p> If we aren’t able to include you at the wedding itself, we truly hope that we will get a chance in the future to visit and celebrate with you personally. If you’re wanting to see Minneapolis, we have a great guest room and would be delighted to host you sometime. </p><p> Additionally, we hope to include and honor those whom we couldn’t invite, or who are unable to attend, by asking you to send us two precious things: photos of yourself/yourselves to include in a display at the wedding (and that we will put in a book to treasure), and a favorite recipe  handwritten on a 4x6 card for what will be our recipe 'guest book'. We are hoping to send out blank recipe cards and invites in late June or early July, but feel free to reach out to us in advance if you'd like."
      },
      {
        question: "For gifts, are you registered anywhere?",
        answer: "If it would bring you joy to give us a wedding gift, we gratefully invite you to choose something from among your favorite local shops and crafters -- or, if you prefer gift registries, see below for ideas:<p><h4><ul><li><a href='https://www.amazon.com/wedding/michelle-c-funk-ross-conklin-minneapolis-october-2016/registry/18WKDHOICP3YT'>Amazon.com Universal Registry</a>:&nbsp;Amazon lets us register anything we can find on the web, so this includes a number of suggestions for local businesses and non-stuff gift ideas.</li><li><a href='http://www.etsy.com/registry/ODE2MTY4OXw4MzM5MTE0/'>Etsy.com</a>:&nbsp; Local crafters from around the world sell their goods on Etsy! Mostly kitchen, home & garden pieces on this list.</li><li><a href='http://www.target.com/gift-registry/registry/MLk15I0yrWXIlfr6NKA4pA'>Target</a>:&nbsp;There are a number of wonderful practical things here that we could really use.</li></ul></h4>"
      },
      {
